...
public class DataManager {
    ...
    public static void prepareTestDataForSegmentation(
        ...
        try (BufferedReader original = bReader(testDataPath);
            ...
            System.out.println("Preparing segmentation test data at " + testDataPath + " ...");
            ...
            System.out.println("Preparing segmentation test data finished.");
        } catch (IOException e) {
            e.printStackTrace();
            exit(1);
        }
    ...
    public static void prepareTestDataForPosTagging(
        ...
        try (BufferedReader original = bReader(testDataPath);
            ...
            System.out.println("Preparing POS tagging test data at " + testDataPath + " ...");
            ...
            System.out.println("Preparing POS tagging test data finished.");
        } catch (IOException e) {
            e.printStackTrace();
            exit(1);
        }
